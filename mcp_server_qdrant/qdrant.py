...
class QdrantConnector:
    ...
    def __init__(
        ...
        self._vector_name_override = vector_name_override
    ...
    async def store(self, entry: Entry, *, collection_name: str | None = None):
        ...
        # Add to Qdrant
        vector_name = self._vector_name_override or self._embedding_provider.get_vector_name()
    ...
    async def search(
        ...
        *,
        ...
        return [
            Entry(
                content=result.payload.get("document") or result.payload.get("text") or "",
